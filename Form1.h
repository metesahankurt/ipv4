...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->GBGenerator->Text = L"Olustur";
			// 
			// flowLayoutPanel1
			// 
			...
			this->labelSousReseau->Text = L"Alt Aglar :";
			...
			this->btnNewIP->Text = L"Yeni IP adresi olustur";
			...
			this->gbQuestions->Text = L"Sorular";
			// 
			// flowLayoutPanel2
			// 
			...
			this->labelQuest1->Text = L"- Bu IP adresinin sinifi nedir? \?";
			...
			this->repIPClass->Text = L"Seciniz";
			// 
			// labelQuest2
			// 
			...
			this->labelQuest2->Text = L"- Bu IP adresi neyi isaret ediyor? \?";
			this->labelQuest2->TextAlign = System::Drawing::ContentAlignment::MiddleLeft;
			// 
			// repIPType
			// 
			this->repIPType->Items->AddRange(gcnew cli::array< System::Object^  >(3) { L"Ağ", L"Makine", L"Yayin" });
			...
			this->labelQuest3->Text = L"- Bu, Internet'te yönlendirilebilir bir adres mi? \?";
			this->labelQuest3->TextAlign = System::Drawing::ContentAlignment::MiddleLeft;
			// 
			// repIsIPRoutable
			// 
			this->repIsIPRoutable->Items->AddRange(gcnew cli::array< System::Object^  >(2) { L"Hayir", L"Evet" });
			...
			this->repIsIPRoutable->Text = L"Seciniz";
			// 
			// flowLayoutPanel4
			// 
			...
			this->txtRepAdrReseau->Locatiozn = System::Drawing::Point(3, 93);
